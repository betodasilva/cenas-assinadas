...
$page_title = esc_html__( 'Blog', 'rango' );
...
<div class="container">
	...
	<?php else : ?>
	<header class="page-header">
		<h2 class="page-title"><?php esc_attr( 'Posts', 'rango' ); ?></h2>
	</header>
	<?php endif; ?>
		...
		<main id="main" class="site-main col-sm-9"  style="<?php if( $page_column_class['left_sidebar'] || $page_column_class['right_sidebar']) { ?>width: 75%;<?php }else{ ?>width:100%;<?php } ?>">
			...
			if ( have_posts() ) :
				...
				the_posts_pagination( array(
					...
					'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( '', 'rango' ) . ' </span>',
				) );
