			...
			<?php
				...
				while ( have_posts() ) : the_post();
					...
					the_post_navigation( array(
						'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'rango' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'rango' ) . '</span> <span class="nav-title"><span class="nav-title-icon-wrapper">' . ftc_get_svg( array( 'icon' => 'arrow-left' ) ) . '</span>%title</span>',
						'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'rango' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'rango' ) . '</span> <span class="nav-title">%title<span class="nav-title-icon-wrapper">' . ftc_get_svg( array( 'icon' => 'arrow-right' ) ) . '</span></span>',
					) );
