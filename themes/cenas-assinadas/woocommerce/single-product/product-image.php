...
<div class="details-img">
	...
	<?php
		...
		if ( has_post_thumbnail() ) {
			...
			$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'rango' ) );
			$html .= '</div>';
		}
...
<?php do_action('bt_after_product_image'); ?>
